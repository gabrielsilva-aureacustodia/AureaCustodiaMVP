...
| `PENDENCIAS_AGENTE_A.md` · `_B.md` · `_C.md` | Pedidos a outra frente (arquivo fora do território) e ações manuais do Gabriel, com o valor literal e completo | O agente da frente |
