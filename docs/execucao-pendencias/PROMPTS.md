...
Um bloco por agente. **E1 a E7 podem ser enviados ao mesmo tempo.** A integração vai quando as sete
relatarem pronta; a E8, depois da integração. Cada prompt serve para Claude Code, Codex ou outro agente
...
Antes de cada push: npm run typecheck; npm run lint; npm test; npm run build. Termine com git push -u origin exec/e4-custodia-preco-e-inadimplencia e o relatório docs/execucao-pendencias/relatorios/E4.md (o que fez, testes, o que conferiu e como, riscos, passos manuais com valor literal completo), cuja última linha é "E4 pronta para integração — <hash>". NÃO faça merge na main.
```

---

## E5 · Análise, testes e melhorias do painel — entrada, resultados, equipe, CS e usuários

```text
Você é o agente de execução E5 do repositório AureaCustodiaMVP (Áurea Custódia / Real Olímpico), em C:\dev\AureaCustodiaMVP.
...
## E6 · Análise, testes e melhorias do painel — bancada, moedas, logística e configuração

```text
Você é o agente de execução E6 do repositório AureaCustodiaMVP (Áurea Custódia / Real Olímpico), em C:\dev\AureaCustodiaMVP.
