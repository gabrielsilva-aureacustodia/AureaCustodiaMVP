...
- **Quando roda:** esta é uma branch de revisão e melhoria, então **só começa depois que E1, E2, E3, E4
  ...
  já integrada, e a revisão cobre também o que E1–E4 mudaram nas áreas desta branch. Com E5 e E6 as
  duas depois da integração, as regras de convivência com E1 e E2 deste documento deixam de valer: o
  código delas já está na base.
- **Leia só:** este documento, `00_PLANO_MESTRE.md`, `relatorios/INTEGRACAO.md`, os relatórios das
  branches que tocaram estas áreas (`relatorios/E2.md` e `relatorios/E4.md`) e os arquivos citados em
...
- **Prioridade:** primeiro os defeitos concretos listados nas Tarefas, na ordem numérica, cada um
  ...
  sobrar.
- **MD de execução:** crie `relatorios/E6_EXECUCAO.md` na primeira ação e acrescente uma linha a cada
