...
export const DEFINICOES_CONFIG: readonly DefinicaoConfig[] = [
  ...
  { chave: 'custodiaMensalPorMoeda', grupo: 'taxas', tipo: 'centavos', padrao: T.custodiaMensalPorMoeda, min: 0, max: 100_000, rotulo: 'Custódia — plano mensal, por moeda', descricao: 'Valor mensal por moeda sob guarda.' },
