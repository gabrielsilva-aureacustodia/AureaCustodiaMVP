...
export const DEFINICOES_CONFIG: readonly DefinicaoConfig[] = [
  ...
  { chave: 'custodiaMensalPorMoeda', grupo: 'taxas', tipo: 'centavos', padrao: T.custodiaMensalPorMoeda, min: 0, max: 100_000, rotulo: 'Custódia — plano mensal, por moeda', descricao: 'Cobrada por mês, por moeda sob guarda.' },
  { chave: 'custodiaAnualPorMoeda', grupo: 'taxas', tipo: 'centavos', padrao: T.custodiaAnualPorMoeda, min: 0, max: 1_000_000, rotulo: 'Custódia — plano anual, por moeda', descricao: 'Cobrada por ano, por moeda sob guarda.' },
