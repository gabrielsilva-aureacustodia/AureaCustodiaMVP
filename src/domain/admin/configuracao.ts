...
export const DEFINICOES_CONFIG: readonly DefinicaoConfig[] = [
  ...
  { chave: 'custodiaBienalPorMoeda', grupo: 'taxas', tipo: 'centavos', padrao: T.custodiaBienalPorMoeda, min: 0, max: 1_000_000, rotulo: 'Custódia — plano de 24 meses, por moeda', descricao: 'Valor dos 24 meses, por moeda sob guarda.' },
  { chave: 'custodiaBienalParcelasMax', grupo: 'taxas', tipo: 'inteiro', padrao: T.custodiaBienalParcelasMax, min: 1, max: 12, unidade: 'x', rotulo: 'Custódia de 24 meses — parcelas no cartão', descricao: 'Máximo de parcelas do plano de 24 meses.' },
...
export function tabelaDeTaxasDe(v: ValoresConfig): TabelaDeTaxas {
  ...
  return {
    ...
    custodiaBienalPorMoeda: n('custodiaBienalPorMoeda'),
    custodiaBienalParcelasMax: n('custodiaBienalParcelasMax'),
